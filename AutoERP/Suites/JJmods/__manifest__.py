{
    ...
    'repositories': [
        {
            ...
            'localname':        "Payroll",
            'odoo_releases':    ["13.0", "14.0", "15.0", "16.0", ],
            'modpaths': [
                ".",
                ],
            },
        {
            ...
            'branch':           "apps-dev",
            'odoo_releases':    ["11.0", "12.0", "13.0", "14.0", "15.0", "16.0", ],
    ...
    'modules':  [
        ...
        { 'name': 'hr_payroll_community',           'active': [                "13.0", "14.0", "15.0", "16.0", ], },
        { 'name': 'hr_contract_types',              'active': [                "13.0", "14.0", "15.0", "16.0", ], },
        # Generic features:
